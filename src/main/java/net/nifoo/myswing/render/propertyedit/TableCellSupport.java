...
public abstract class TableCellSupport<T extends JComponent> implements TableCellEditor, TableCellRenderer {
	...
	private List<WeakReference<CellEditorListener>> listeners = new ArrayList();
	...
	public boolean stopCellEditing() {
		try {
			...
			JOptionPane.showMessageDialog(component, e.getMessage(), "Error Input", JOptionPane.ERROR_MESSAGE);
			return false;
		}
	}
