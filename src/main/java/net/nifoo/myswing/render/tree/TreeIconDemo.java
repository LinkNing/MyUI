...
public class TreeIconDemo extends JPanel implements TreeSelectionListener {
	...
	public TreeIconDemo() {
		...
		if (true) {
			...
			renderer.setIcon(createImageIcon("resources/category.png"));
			renderer.setLeafIcon(createImageIcon("resources/book.png"));
			renderer.setOpenIcon(createImageIcon("resources/open.png"));
			renderer.setClosedIcon(createImageIcon("resources/close.png"));
